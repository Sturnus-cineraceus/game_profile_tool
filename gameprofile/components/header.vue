<template>
  <div>
    <b-navbar toggleable="lg" type="dark" variant="info">
      <b-navbar-brand @click="$router.push({ path: '/' })" href="#">フォトナプロフ プレα</b-navbar-brand>
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item @click="goProfile" v-if="inLogin && existsPublicProfile" href="#">自分のプロフィール表示</b-nav-item>
          <b-nav-item v-if="!inLogin" @click="$router.push({ path: '/login' })" href="#">ログイン</b-nav-item>
          <b-nav-item v-if="inLogin" @click="$router.push({ path: '/logout' })" href="#">ログアウト</b-nav-item>
        </b-navbar-nav>
      </b-collapse>
    </b-navbar>
  </div>
